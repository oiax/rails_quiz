...
ActiveRecord::Schema.define(version: 20151117150428) do
  ...
  add_foreign_key "messages", "messages", column: "root_id", name: "messages_root_id_fk"
  ...
  add_foreign_key "programs", "staff_members", column: "registrant_id", name: "programs_registrant_id_fk"
